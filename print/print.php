...
//add_filter('comments_array', 'wp_side_comments_print_comments');
remove_filter('comments_array', 'wp_side_comments_get_comments_filter');
...
if(file_exists(TEMPLATEPATH.'/print-posts.php')) {
	...
	include(WP_PLUGIN_DIR.'/wp-side-comments/print/print-posts.php');
}
?>